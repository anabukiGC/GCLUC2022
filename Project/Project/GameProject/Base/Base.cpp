...
void Base::Draw3D()
{
	...
	CVector2D rect_ltf = Get2DPos(CVector3D(rect1.m_left, rect1.m_top, rect1.m_near));//‚RD‚ð‚QDÀ•W‚É•ÏŠ·
	CVector2D rect_rbf = Get2DPos(CVector3D(rect1.m_right, rect1.m_bottom, rect1.m_near));//‚RD‚ð‚QDÀ•W‚É•ÏŠ·
	...
	CVector2D rect_ltn=Get2DPos(CVector3D(rect1.m_left,rect1.m_top,rect1.m_far));//‚RD‚ð‚QDÀ•W‚É•ÏŠ·
	CVector2D rect_rbn = Get2DPos(CVector3D(rect1.m_right, rect1.m_bottom, rect1.m_far));//‚RD‚ð‚QDÀ•W‚É•ÏŠ·
